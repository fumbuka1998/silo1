                                    ...
                                    $('.save_sub_contract_item').each(function(){
                                        ...
                                        if(button.attr('active') != 'true') {
                                            ...
                                            button.click(function () {
                                                ...
                                                var modal = button.closest('.modal');
                                                var thead = modal.find('thead');

                                                var sub_contract_id = thead.find('input[name="sub_contract_id"]').val();
                                                var task_id = thead.find('select[name="task_id"]').val();
                                                var start_date = thead.find('input[name="start_date"]').val();
                                                var end_date = thead.find('input[name="end_date"]').val();
                                                var contract_sum = thead.find('input[name="contract_sum"]').unmask();
                                                var description = thead.find('input[name="description"]').val();
                                                ...
                                                if(sub_contract_id != '' && start_date != '') {
                                                    ...
                                                    $.post(
                                                        base_url + "Sub_contractors/save_sub_contract_item/",
                                                        {
                                                            ...
                                                            initialize_common_js();
                                                            toast('success',thead.find('form').html());
                                                            thead.find('form')[0].reset();
