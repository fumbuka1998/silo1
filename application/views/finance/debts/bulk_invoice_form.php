<div class="modal-dialog modal-lg" style="width: 80%">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?= 'Tax Invoice(Bulk)' ?></h4>
        </div>
        <form>
            <div class="modal-body" style="overflow:auto;">
                ...
                <div class="form-group col-md-4">
                    ...
                    <?= form_dropdown('client_id',$client_options, '', ' class="form-control searchable"'); ?>
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="col-xs-12 table-responsive">
                    <table class="table table-hover">
                        <thead>
                        <tr>
                            <td style="width: 350px;"><strong>Description</strong></td><td><strong>Quantity</strong></td><td><strong>UOM</strong></td><td><strong>Rate</strong></td><td><strong>Amount</strong></td><td></td>
                        </tr>
                            <tr class="row_template" style="display: none">
                                <td>
                                    <?= form_dropdown('debted_item_id', [], '', ' class="form-control"'); ?>
                                    <input type="hidden" name="item_type" value="">
                                    <input type="hidden" name="debt_nature" value="">
                                    <input type="hidden" name="debt_nature_id" value="">
                                </td>
                                <td>
                                    <input style="text-align: right" type="text" class="form-control" name="quantity" value="">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input style="text-align: right; width: 150px;" type="text" class="form-control number_format" name="rate" value="">
                                </td>
                                <td>
                                    <input style="text-align: right; width: 150px;" type="text" class="form-control number_format" name="amount" value="" readonly>
                                </td>
                                <td>
