    ...
    <div class="modal-content">
        ...
        <form>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control datepicker" name="invoice_date" value="<?= $outgoing_invoice->invoice_date ?>">
                <input type="hidden" name="outgoing_invoice_id" value="<?= $outgoing_invoice->{$outgoing_invoice::DB_TABLE_PK} ?>">
            </div>
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
                ...
                <?= form_dropdown('currency_id', $currency_options, $outgoing_invoice->currency_id, ' class="form-control searchable"'); ?>
            </div>
            <div class="form-group col-md-4">
                <label for="reference" class="control-label">Reference</label>
                <input type="text" class="form-control" name="reference" value="<?= $outgoing_invoice->reference ?>">
            </div>
            <div class="form-group col-md-4">
                <label for="invoice_no" class="control-label">Invoice No</label>
                <input type="text" class="form-control" name="invoice_no" value="<?= $outgoing_invoice->invoice_no ?>">
            </div>
                            ...
                            <td colspan="4"  style="text-align: right; font-weight: bold">
                                <div class="col-xs-12">
                                    <div style="text-align: left" class="form-group col-xs-6">
                                        <input type="checkbox" name="vat_inclusive" <?= $outgoing_invoice->vat_inclusive == 1 ? 'checked' : '' ?> >
                                        <input type="hidden" name="vat_percentage" class="form-control" value="<?= $outgoing_invoice->vat_percentage ?>">
                                        &nbsp;&nbsp;
            ...
            <div class="form-group col-xs-12">
                ...
                <textarea id="bank_details_text_area" readonly class="form-control" name="bank_details" rows="7"><?= $outgoing_invoice->bank_details  ?></textarea>
            </div>
            <div class="form-group col-xs-12">
                <label for="remarks" class="control-label">Payment Terms</label>
                <textarea class="form-control" name="payment_terms" rows="5"><?= $outgoing_invoice->payment_terms ?></textarea>
            </div>
        </div>
        </form>
