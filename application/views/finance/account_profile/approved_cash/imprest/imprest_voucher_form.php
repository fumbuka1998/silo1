...
<div style="width: 90%" class="modal-dialog modal-lg">
            ...
            <div class='row'>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control datepicker" required name="issue_date" value="">
                        ...
                        <input type="hidden" name="imprest_id" value="">
                 
                    </div>

                     <div class="form-group col-md-2">
                        <label for="debit_account_id" class="control-label">Debit Account</label>
                        <?= form_dropdown('debit_account_id',$contra_debit_account_options,'',' class="form-control searchable"') ?>
                    </div>


                     <div class="form-group col-md-2">
                        <label for="handler" class="control-label">Assign Handler</label>
                        <input type="text" class="form-control" required name="handler" value="">
                     </div>
    ...
    <?php
        ...
        //inspect_object($requisition_approval);

        foreach ($cash_items as $item){
            $sn++;
            $total_amount += $amount = $item->approved_quantity*$item->approved_rate;
            //inspect_object($item->requisition_cash_item());
            ?>
            <tr>
                <td><?= $sn ?></td>
