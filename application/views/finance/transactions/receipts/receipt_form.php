                ...
                <div class='row'>
                    <div class="col-xs-12">
                        ...
                        <div class="form-group col-md-4 ">
                            ...
                            <?= form_dropdown('invoice_id',$edit ? [$receipt->invoice_id => $receipt->outgoing_invoice()->invoice_no] : $outgoing_invoice_options, $edit ? $receipt->invoice_id : '', ' class="form-control searchable" ') ?>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="name" class="control-label">Credit Account</label>
                            <?= form_dropdown('credit_account_id',$edit ? [$receipt->credit_account('id') => $receipt->credit_account('name')] : [], '', ' class="form-control searchable" ') ?>
                        </div>
                        <div class="form-group col-md-4 ">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control"  name="withholding_tax" value="<?= $edit ? $receipt->withholding_tax : ''?>" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="amount_withheld" class="control-label">Amount Withheld</label>
                            <input type="text" class="form-control"  name="amount_withheld" value="<?= $edit ? number_format($receipt->withheld_amount()) : '' ?>" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="amount_retained" class="control-label">Received Amount</label>
                            <input type="text" class="form-control number_format"  name="amount_payable" value="<?= $edit ? number_format($receipt->amount()) : '' ?>" >
                        </div>
                        <div class="form-group col-md-4">
                            <label for="name" class="control-label">Debit Account</label>
                            <?= form_dropdown('debit_account_id', $debit_account_options, $edit ?  $receipt->debit_account('id') : '' , ' class="form-control searchable" ') ?>
                        </div>
                        <div class="form-group col-md-4">
