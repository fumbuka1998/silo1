...
<div style="width: 100%">
    ...
    <div id="retire_imprest_<?= $imprest_voucher->{$imprest_voucher::DB_TABLE_PK} ?>" class="modal fade imprest_retirement_form" role="dialog">
        <?php
            $this->load->view('finance/transactions/approved_cash_requests/imprest/imprest_retirement_form');
        ?>
    </div>
    <div id="imprest_documents_<?= $imprest_voucher->{$imprest_voucher::DB_TABLE_PK} ?>" class="modal fade imprest_documents" role="dialog">
        <?php
            $this->load->view('finance/transactions/approved_cash_requests/imprest/imprest_documents');
        ?>
    </div>
</div>
