    ...
    <div class="modal-content">
        ...
        <form>
                ...
                <div class='row'>
                    <div class="col-xs-12">
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control datepicker" required name="imprest_date"
                                   value="<?= date('Y-m-d') ?>">
                            <input type="hidden" name="requisition_approval_id"
                                   value="<?= $requisition_approval->{$requisition_approval::DB_TABLE_PK} ?>">
                        ...
                        <?php if ($currency->{$currency::DB_TABLE_PK} != 1) { ?>
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control number_format" required name="exchange_rate"
                                       value="<?= currency_exchange_rate($currency->{$currency::DB_TABLE_PK}) ?>">
                            </div>
                        <?php } else {
                            ?>
                        ...
                        <table width="100%" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $material->item_name ?>
                                            ...
                                            <input type="hidden" name="item_id"
                                                   value="<?= $material->{$material::DB_TABLE_PK} ?>">
                                            <input type="hidden" name="requisition_approval_material_item_id"
                                                   value="<?= $item->{$item::DB_TABLE_PK} ?>">
                                            ...
                                            <div class="form-group col-xs-12">
                                                <div class="input-group">
                                                    <input type="text" name="rate" class="form-control money"
                                                           value="<?= number_format($item->approved_rate, 2) ?>">
                                                    <span class="input-group-addon currency_display"> <?= $item->currency()->symbol ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td style="text-align: right"><input name="amount" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $asset_item->asset_name ?>
                                            <input type="hidden" name="description"
                                                   value="<?= $asset_item->asset_name ?>">
                                            <input type="hidden" name="asset_item_id"
                                                   value="<?= $asset_item->{$asset_item::DB_TABLE_PK} ?>">
                                            <input type="hidden" name="requisition_approval_asset_item_id"
                                                   value="<?= $item->{$item::DB_TABLE_PK} ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="description" readonly
                                                   value="<?= $item->requisition_cash_item()->description ?>"
                                                   class="form-control">
                                            <input type="hidden" name="item_id" value="">
                                            <input type="hidden" name="requisition_approval_cash_item_id"
                                                   value="<?= $item->{$item::DB_TABLE_PK} ?>">
                            ...
                            foreach ($service_items as $item) {
                                ...
                                if ($quantity_to_pay > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="description" readonly
                                                   value="<?= $item->requisition_service_item()->description ?>"
                                                   class="form-control">
                                            <input type="hidden" name="item_id" value="">
                                            <input type="hidden" name="requisition_approval_service_item_id"
                                                   value="<?= $item->{$item::DB_TABLE_PK} ?>">
                            ...
                            <tr>
                                ...
                                <th style="text-align: right"
                                    class="total_amount_display"><?= number_format($total_amount, 2) ?></th>
                            </tr>
                            <?php
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-danger revoke_approved_payment"><i class="fa fa-ban"></i>
                    Revoke
                </button>
                <button type="button" class="btn btn-sm btn-default save_imprest_voucher"><i
