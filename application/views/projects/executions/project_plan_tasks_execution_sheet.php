...
?>
<h2 style="text-align: center"><?= $project->project_name . ' ' . $project_plan->title ?></h2>
...
<?php
    ...
    <table  style="font-size: 12px" width="100%">
        <tr>
            <td><strong>Plan Tittle:</strong><?= $project_plan->title ?></td>
    ...
    <?php
    $plan_executed_tasks = $project_plan->plan_executed_tasks(false);
    $sn = 0;
        ...
        foreach ($plan_executed_tasks as $plan_executed_task) {
            ...
            <table style="font-size: 12px" width="100%" border="1" cellspacing="0"
                ...
                if (!empty($plan_task_execution_equipments)){
                    ?>
                    <tr>
                        <th style="text-align: center" colspan="6">Equipments</th>
                    </tr>
                    <tr style="background-color: #dfdfdf">
    ...
    <table style="font-size: 12px" width="100%" border="1" cellspacing="0" class="table table-bordered table-hover">
        <tbody>
        <tr style="font-weight: bold; background-color: #dfdfdf">
            <th style="text-align: left" colspan="5">OVERALL COST FOR THIS PLAN EXECUTION </th>
...
<table width="100%">
    <tr>
        <td style="width: 50%">
            <strong>Issued By: </strong><?= $project_plan->created_by()->full_name() ?>
        </td>
        <td style="width: 50%">
