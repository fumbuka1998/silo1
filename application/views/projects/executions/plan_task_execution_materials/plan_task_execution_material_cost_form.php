 ...
 */
    ...
    $edit = isset($item);
    if($edit){
        $plan_task_material_cost = $item->project_plan_task_execution_material_cost();
    }
?>
            ...
            <div class='row'>
                <div class="col-xs-12">
                    <div class="form-group col-md-12">
                        <label for="date" class="control-label">Executed Task</label>
                        <?= form_dropdown('plan_task_execution_id',
                            $edit ? [$plan_task_material_cost->plan_task_execution_id=>$plan_task_material_cost->project_plan_task_execution()->task()->task_name] : [],
                            $edit ? $plan_task_material_cost->plan_task_execution_id : '',
