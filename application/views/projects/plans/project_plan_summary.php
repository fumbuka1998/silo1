...
<div style="width: 80%" class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?= $project_plan->title ?>&nbsp;Summary</h4>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a class="project_plan_details_activator" href="#project_plan_summary_tab_<?= $project_plan_id ?>" project_plan_id="<?= $project_plan_id ?>" data-toggle="tab">Summary</a></li>
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="project_plan_summary_tab_<?= $project_plan_id ?>">
                            <?php
                            $this->load->view('projects/plans/project_plan_summary_tab');
                            ?>
                        </div>
