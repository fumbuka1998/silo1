...
$work_performed_cost = $project_plan->plan_budgeted_cost($project_plan->{$project_plan::DB_TABLE_PK});
                    ...
                    <div class="form-horizontal col-xs-12">
                        ...
                        <div class="form-gruop col-md-12">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                <td><?= number_format($work_performed_cost, 2) ?></td>
                                <td><?= number_format($actual_cost, 2) ?></td>
                                <td><?= $actual_cost != 0 ? round(($work_performed_cost / $actual_cost), 2) : 0 ?></td>
                                <td><?= number_format(($work_performed_cost - $actual_cost), 2) ?></td>
                                </tbody>
                            </table>
                        </div>
                    </div>
