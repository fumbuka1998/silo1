 ...
 */
    ...
    $budget = $task->budget_figure();
    $timeline_percentage = $task->timeline_percentage();
    $percentage_completion = $task->completion_percentage();
    $budget_spending_percentage = $task->budget_spending_percentage();
    $elapsed_days = $task->elapsed_days();
