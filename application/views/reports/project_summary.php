<?php $this->load->view('includes/header');?>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Projects Summary</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border no-print">
                            <div class="col-xs-12">
                                <div class="box-tools">
                                    <form method="post" target="_blank" action="<?= base_url('reports/project_summary') ?>">
                                        ...
                                        <div class="col-md-3">
                                            <br/>
                                            <button id="generate_project_summary_report" type="button" class="btn btn-default btn-xs">Generate</button>
