                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border no-print">
                            <div class="col-xs-12">
                                <div class="box-tools">
                                    <form method="post" target="_blank" action="<?= base_url('reports/project_material_status') ?>">
                                        ...
                                        <div class="col-md-3">
                                            <br/>
                                            <button id="generate_project_material_balance_report" type="button" class="btn btn-default btn-xs">Generate</button>
