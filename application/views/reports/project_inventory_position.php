<?php $this->load->view('includes/header');?>
        ...
        <section class="content-header">
            <h1>
                Reports
                <small>Projects Inventory Position</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?= base_url()?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                <li><a href="<?= base_url('reports')?>"><i class="fa fa-pie-chart"></i>Reports</a></li>
                <li class="active">Projects Inventory Position</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border no-print">
                            <div class="col-xs-12">
                                <div class="box-tools">
                                    <form method="post" target="_blank" action="<?= base_url('reports/project_inventory_position') ?>">
                                        ...
                                        <div class="col-md-3">
                                            <br/>
                                            <button id="generate_project_inventory_position_report" type="button" class="btn btn-default btn-xs">Generate</button>
