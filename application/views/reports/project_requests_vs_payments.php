            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border no-print">
                        <div class="col-xs-12">
                            <div class="box-tools">
                                <form method="post" target="_blank" action="<?= base_url('reports/requests_vs_payments') ?>">
                                    ...
                                    <div class="col-md-3">
                                        <br/>
                                        <button id="generate_project_requests_vs_payments_report" type="button" class="btn btn-default btn-xs">Generate</button>
