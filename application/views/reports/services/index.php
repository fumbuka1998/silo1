        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border no-print">
                    <div class="col-xs-12">
                        <div class="box-tools">
                            <form method="post" target="_blank" action="<?= base_url('reports/services') ?>">
                                <div class="form-group col-md-6">
                                    <label for="" class="control-label">Clients</label>
                                    <?php
                                        echo form_multiselect('client_ids[]', $client_options, '', ' class="client_ids form-control searchable" ')
                                    ?>
                                ...
                                <div class="col-md-2">
                                    <br/>
                                    <button id="generate_services_report" type="button" class="btn btn-default btn-xs">Generate</button>
                ...
                <div class="box-body">
                    <div class="row">
                        <div id="service_report_container" class="col-xs-12 table-responsive">
