...
<table cellspacing="0.5" class="table-main" style="table-layout: fixed">
        ...
        <td style="width: 50%">
            <table cellspacing="0.5" class="table-to-table">
                <tr>
                    ...
                    <td style="color: #417AC0; height: 10px; text-align: right"><?= $payment_request_approval->cost_center_name() ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="color: #31314E; height: 10px; text-align: left">Request Date :</td>
                    <td style="color: #417AC0; height: 10px; text-align: right"><?= set_date($payment_request->request_date) ?></td>
                </tr>
                <tr>
    ...
    <tr style="background-color: #8E3518;">
        <td colspan="2"
            style="padding: 8px; width: 100%; text-align: center; color: white; font-size: 14px"><?= $payment_request_approval->cost_center_name() ?></td>
    </tr>
    <tr>
        <td colspan="2" style="width: 100%">
