...
if(!empty($invoices)){
    foreach ($invoices as $invoice){
        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" invoice_id="<?= $invoice->{$invoice::DB_TABLE_PK} ?>" class="btn btn-danger btn-xs delete_grn_invoice">
    ...
    <tr>
        <td colspan="6">
            <div class="alert alert-info">No GRN invoices found for order <?= $order->order_number() ?></div>
        </td>
    </tr>
<?php
}
