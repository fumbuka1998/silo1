                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <?= form_dropdown('stakeholder_id',$stakeholder_options, $edit ? $sale->stakeholder_id : '', ' class="form-control searchable"') ?>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="control_label">Project</label>
                            <?= form_dropdown('project_id', $edit ? [$sale->project_id => $sale->project()->project_name] : $project_options, $edit ? $sale->project_id : '', ' class="form-control searchable"') ?>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="reference" class="control-label">Reference</label>
                            <input type="text" class="form-control" required name="reference" value="<?= $edit ? $sale->reference : '' ?>">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="control_label">Currency</label>
                            <?= form_dropdown('currency_id', !$edit || $paid_amount == 0 ? $currency_options : [$sale->currency_id => $sale->currency()->currency_name], $edit ? $sale->currency_id : '', ' class="form-control searchable"') ?>
                        </div>
                        ...
                        <div class="col-xs-12 table-responsive">
                            <table class="table table-hover table-bordered table-responsive">
                                ...
                                <?php if(!$edit){?>
                                <tr>
                                    <td style="max-width: 290px; min-width: 290px" >
                                        <?= form_dropdown('source_sub_location_id', $sub_location_options, '', ' class="form-control searchable"  style="width: 220px;" ') ?>
                                    </td>
                                    <td style="max-width: 290px; min-width: 290px">
                                        <?= form_dropdown('material_id', [], '', ' class="form-control searchable" style="width-max: 290px;" ') ?>
                                        <input type="hidden" name="item_type" value="material">
                                    </td>
                                    <td>
                                        <div class="input-group">
                                ...
                                <?php } else {
                                    ...
                                    foreach ($material_items as $item){
                                        ...
                                        <tr>
                                            <td>
                                                <?= form_dropdown('source_sub_location_id', [$source_sub_location->{$source_sub_location::DB_TABLE_PK} => $source_sub_location->sub_location_name], $item->source_sub_location_id, ' class="form-control searchable" ') ?>
                                            </td>
                                            <td style="max-width: 350px">
                                ...
                                <?php
                                    ...
                                    foreach ($asset_items as $item){
                                        $latest_history = $item->asset_sub_location_history();
                                        $asset = $latest_history->asset();
                                        $history_id = $latest_history->{$latest_history::DB_TABLE_PK};
                                        $source_sub_location = $latest_history->sub_location()
                                        ?>
                                        <tr>
                                            <td>
                                                <?= form_dropdown('source_sub_location_id', [$source_sub_location->{$source_sub_location::DB_TABLE_PK} => $source_sub_location->sub_location_name], $latest_history->sub_location_id, ' class="form-control searchable" ') ?>
                                            </td>
                                            <td style="max-width: 350px">
                                ...
                                <tr>
                                    <td colspan="8">
                                        <button type="button" class="btn btn-default btn-xs sales_asset_row_adder pull-right">
                                            <i class="fa fa-plus"></i> Asset
                                        </button>
                                        <span class="pull-right">&nbsp;</span>
                                        <button type="button" class="btn btn-default btn-xs sales_material_row_adder pull-right">
