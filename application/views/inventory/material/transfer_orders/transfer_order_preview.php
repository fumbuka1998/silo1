...
<table style="width: 100%">
    <tr>
       <td style="width: 50%;font-size: 15px;"><b>Source: </b><br/> <?=$location->location_name ?></td>

        <td style="font-size: 15px;"><b>Destination: </b><br/><?=$requisition_approval->requisition()->cost_center_name() ?></td>
    </tr>
</table>
<br>
<table style="font-size: 10px" width="100%" border="1" cellspacing="0">
    ...
    $sn = 0;
    foreach ($transfer_order_material_items as $item){
    ...
    foreach ($transfer_order_asset_items as $item){
        $approval_item=$item['approval_item'];
