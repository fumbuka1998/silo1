...
if($order_grn){
    $order = $order_grn->purchase_order();
    $currency = $order->currency();
    $factor = $order_grn->factor*$order_grn->exchange_rate;
} else if($imprest_grn){
...
<br/>
<table cellpadding="3" style="font-size: 10px" width="100%" cellspacing="0">
    <thead>
    <tr>
        <th class="bordered">S.No.</th>
        <th class="bordered">Item Description</th>
        <th class="bordered">Part No.</th>
        <th class="bordered">Unit</th><th class="bordered">Received Quantity</th>
        <?php if($order_grn){ ?>
            <th class="bordered">Delivered Quantity</th>
            <th class="bordered">Rejected Quantity</th>
            <th colspan="2" class="bordered">Unit Price</th class="bordered"><th colspan="2" class="bordered">Amount</th>
            <th class="bordered">Cost P.U (TSHS)</th><th class="bordered">Amount(TSH)</th>
    ...
    <?php if($order_grn){ ?>
        <tr style="background-color: #BBBBBB;">
            ...
            <th class="bordered"></th><th class="bordered" style="text-align: right"><?= number_format($total_amount,2) ?></th>
        </tr>
...
if($order_grn){
    ...
    $grand_total_value = 0;
    ?>
    <table  cellpadding="3"  style="font-size: 10px" class="duties_table" cellspacing="0" width="70%">
        ...
        <tr>
            <td style="text-align: center" class="bordered">Less VAT</td>
            <td class="left_bordered"></td>
            <td class="right_bordered" style="text-align: right">
