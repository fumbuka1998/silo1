 ...
 * Time: 13:05
 */
class Project_attachment extends MY_Model
{

    const DB_TABLE = 'project_attachments';
    ...
    public function project_attachments_list($limit,$start,$keyword,$order){
        ...
        $sql = 'SELECT SQL_CALC_FOUND_ROWS attachments.* FROM attachments
                LEFT JOIN project_attachments ON attachments.id = project_attachments.attachment_id
                '.$where.$order_string;
