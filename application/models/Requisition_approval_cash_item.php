...
class Requisition_approval_cash_item extends MY_Model{

    const DB_TABLE = 'requisition_approval_cash_items';
    ...
    public function requisition_cash_item()
    {
        $this->load->model('requisition_cash_item');
        $requisition_cash_item = new Requisition_cash_item();
        $requisition_cash_item->load($this->requisition_cash_item_id);
        return $requisition_cash_item;
    }
    ...
    public function save_approval_expense_account($approval_id,$item_id,$account_id){
        $this->load->model('requisition_approval_cash_item_expense_account');
        $expense_account = new Requisition_approval_cash_item_expense_account();
        $expense_account->expense_account_id = $account_id;
        $expense_account->requisition_approval_id = $approval_id;
        $expense_account->requisition_cash_item_id = $item_id;
    ...
    public function payment_vouchers(){
        ...
        $sql = 'SELECT payment_voucher_items.payment_voucher_id 
                ...
                WHERE requisition_approval_cash_item_id = '.$this->{$this::DB_TABLE_PK};
