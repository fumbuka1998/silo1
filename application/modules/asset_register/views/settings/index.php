            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <?php
                     ...
                     ?>
                    <li class="<?= $active_tab == 0 ? 'active' : '' ?>"><a href="#depreciation_list" data-toggle="tab">Asset Depreciation Rates</a></li>
                    <?php
                        $active_tab = 1;
                    } ?>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="<?= $active_pane == 0 ? 'active' : '' ?> tab-pane" id="tools_types">
                        <?php $this->load->view('settings/asset_group/asset_group_tab'); ?>
                    </div>
                    <?php
                            $active_pane = 1;
                        } if(check_permission('Equipment')){
                     ?>
                    <div class="<?= $active_pane == 0 ? 'active' : '' ?> tab-pane" id="depreciation_list">

                        <?php $this->load->view('settings/depreciation/depreciation_list'); ?>
