...
<!--<small>Preview page</small>-->
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Asset Depreciation Report</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border">
                    <div class="col-xs-12">
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <label for="issue_date" class="control-label">AS AT</label>
                      ...
                      <div class="form-group col-md-3">
                       ...
                       <div class="col-lg-2  col-md-2  col-sm-2">
                        <br>
                          <button type="button" class="btn btn-primary input-md" id='filter_button'>
                ...
                <div class="box-body" id="depreciation_list">
                   

                      <?php $this->load->view('asset_reports/depreciation_list');?>  
