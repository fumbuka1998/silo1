        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#existing_contracts" data-toggle="tab">Existing Contracts</a></li>
                    <li><a href="#expired_contracts" data-toggle="tab">Expired Contracts</a></li>
                    <li><a href="#closed_contracts" data-toggle="tab">Closed Contracts</a></li>
                </ul>
                <div class="tab-content">

                    <div class="active tab-pane" id="existing_contracts">
                        <?php $this->load->view('contracts/existing_contracts');?>
                    </div>
